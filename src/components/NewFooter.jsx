          ...
          <div className="grid grid-cols-1 gap-10 md:grid-cols-4">
            ...
            <div className= "lg:pr-16">
              ...
              <ul className="mt-6 space-y-4">
                <li><a href="https://nesbah-638895547402.me-central2.run.app/about" className="text-sm text-white hover:text-white">About</a></li>
                <li><a href="https://news.nesbah.com.sa/" className="text-sm text-white hover:text-white">Blog</a></li>
                <li><a href="https://nesbah-638895547402.me-central2.run.app/contact" className="text-sm text-white hover:text-white">Contact</a></li>
                <li><a href="https://nesbah-638895547402.me-central2.run.app/calculator" className="text-sm text-white hover:text-white">Calculator</a></li>
              </ul>
            </div>
